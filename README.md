# karaf-osgi-rest-service

A short example

### Setting up the karaf environment
Download and unzip karaf 4.3.0
Start the server and the console using 
...
Run the following command in order to review the list of OSGi bundles currently deployed in this environment.
...
```
bundle:install -s mvn:com.orkun.osgi/karaf-osgi-rest-service/0.0.4
```
...
Now add some useful methods to SampleService and deploy them. 
